...
public class frmInventarioVehiculo extends javax.swing.JInternalFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmInventarioVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmInventarioVehiculo().setVisible(true);
            }
        });
    }
