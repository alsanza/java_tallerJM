...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-01-2025 a las 05:28:24
...
(1, 1, '2025-01-17', 1, '2025-01-24'),
(2, 2, '2025-01-17', 2, '2025-01-24'),
(3, 3, '2025-01-18', 3, '2025-01-25');
...
(6, 'Cédula ciudadanía', '70278456', 'Juan Andrés', 'Molina Rojas', 'jandres@gmail.com', '3004879789', 'Carrera 65 # 2Sur - 24', 'Medellín', 1, '2025-01-18 19:48:04');
...
(9, 'Chevrolet', 'Spark', '2018', 'Puerta delantera Derecha', 'Pintar', 180000, '2025-01-18 22:05:41'),
(10, 'Chevrolet', 'Spark', '2018', 'Puerta delantera Derecha', 'Enderezar', 90000, '2025-01-18 22:06:26');
...
(2, 6, 'KMO124', 'Ford', 'Eco Sport', '2012', 'BEIGE'),
(3, 2, 'SNS625', 'Mazda', 'Mazda 2', '2019', 'BLANCO');
...
--
ALTER TABLE `detalle_cotizacion`
  MODIFY `IDdetalle_cotizacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `valor_servicio_pieza`
  MODIFY `IDvalor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
